...
--
-- Struktur dari tabel `daftar_hitam_barang`
--
...
--
-- Dumping data untuk tabel `db_menu`
--
...
--
-- Struktur dari tabel `db_user_akses`
--
...
--
-- Dumping data untuk tabel `db_user_akses`
--
...
--
-- Struktur dari tabel `db_user_level`
--
...
--
-- Dumping data untuk tabel `db_user_level`
--
...
--
-- Struktur dari tabel `gl_barang_keluar`
--
...
CREATE TABLE `gl_barang_keluar` (
  ...
  `simpan` tinyint(1) NOT NULL DEFAULT '0' COMMENT '0=draft, 1=final',
...
--
-- Dumping data untuk tabel `gl_barang_keluar`
--
...
--
-- Struktur dari tabel `gl_barang_keluar_detail`
--
...
--
-- Dumping data untuk tabel `gl_barang_keluar_detail`
--
...
--
-- Struktur dari tabel `gl_data_barang`
--
...
--
-- Dumping data untuk tabel `gl_data_barang`
--
...
--
-- Struktur dari tabel `gl_data_supplier`
--
...
--
-- Dumping data untuk tabel `gl_data_supplier`
--
...
--
-- Struktur dari tabel `gl_jenis_barang`
--
...
--
-- Dumping data untuk tabel `gl_jenis_barang`
--
...
--
-- Dumping data untuk tabel `gl_order`
--
...
--
-- Struktur dari tabel `gl_order_barang`
--
...
--
-- Dumping data untuk tabel `gl_order_barang`
--
...
--
-- Struktur dari tabel `gl_satuan_barang`
--
...
--
-- Dumping data untuk tabel `gl_satuan_barang`
--
...
--
-- Struktur dari tabel `stok_opname_barang`
--
...
--
-- Indeks untuk tabel `daftar_hitam_barang`
--
...
--
-- Indeks untuk tabel `db_user_akses`
--
ALTER TABLE `db_user_akses`
  ADD PRIMARY KEY (`id`) USING BTREE;

--
-- Indeks untuk tabel `db_user_level`
--
...
--
-- Indeks untuk tabel `gl_barang_keluar`
--
...
--
-- Indeks untuk tabel `gl_barang_keluar_detail`
--
...
--
-- Indeks untuk tabel `gl_data_barang`
--
ALTER TABLE `gl_data_barang`
  ADD PRIMARY KEY (`id`) USING BTREE;

--
-- Indeks untuk tabel `gl_data_supplier`
--
ALTER TABLE `gl_data_supplier`
  ADD PRIMARY KEY (`id`) USING BTREE;

--
-- Indeks untuk tabel `gl_jenis_barang`
--
ALTER TABLE `gl_jenis_barang`
  ADD PRIMARY KEY (`id`) USING BTREE;

--
-- Indeks untuk tabel `gl_order`
--
ALTER TABLE `gl_order`
  ADD PRIMARY KEY (`id`) USING BTREE;

--
-- Indeks untuk tabel `gl_order_barang`
--
ALTER TABLE `gl_order_barang`
  ADD PRIMARY KEY (`id`) USING BTREE;

--
-- Indeks untuk tabel `gl_satuan_barang`
--
...
--
-- Indeks untuk tabel `stok_opname_barang`
--
...
--
-- AUTO_INCREMENT untuk tabel `daftar_hitam_barang`
--
ALTER TABLE `daftar_hitam_barang`
  MODIFY `id` int NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT untuk tabel `db_menu`
--
ALTER TABLE `db_menu`
  MODIFY `id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=171;

--
-- AUTO_INCREMENT untuk tabel `db_setting`
--
ALTER TABLE `db_setting`
...
--
-- AUTO_INCREMENT untuk tabel `db_user_akses`
--
ALTER TABLE `db_user_akses`
  MODIFY `id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1554;

--
-- AUTO_INCREMENT untuk tabel `db_user_level`
--
ALTER TABLE `db_user_level`
...
--
-- AUTO_INCREMENT untuk tabel `gl_data_supplier`
--
ALTER TABLE `gl_data_supplier`
  MODIFY `id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT untuk tabel `gl_jenis_barang`
--
ALTER TABLE `gl_jenis_barang`
  MODIFY `id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT untuk tabel `gl_order`
--
ALTER TABLE `gl_order`
  MODIFY `id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;

--
-- AUTO_INCREMENT untuk tabel `gl_order_barang`
--
ALTER TABLE `gl_order_barang`
  MODIFY `id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;

--
-- AUTO_INCREMENT untuk tabel `gl_satuan_barang`
--
ALTER TABLE `gl_satuan_barang`
...
--
-- AUTO_INCREMENT untuk tabel `stok_opname_barang`
--
ALTER TABLE `stok_opname_barang`
  MODIFY `id` int NOT NULL AUTO_INCREMENT;
...
--
-- Ketidakleluasaan untuk tabel `daftar_hitam_barang`
--
ALTER TABLE `daftar_hitam_barang`
...
--
-- Ketidakleluasaan untuk tabel `gl_barang_keluar_detail`
--
ALTER TABLE `gl_barang_keluar_detail`
...
--
-- Ketidakleluasaan untuk tabel `stok_opname_barang`
--
ALTER TABLE `stok_opname_barang`
